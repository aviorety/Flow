...
Currently, Flow supports only a few games, but its journey is far from over. All plans are in motion to expand this hub by adding more scripts for games.

## Community

We are always glad to see a new user on our [Discord server](https://discord.gg/flowrbx). You can have fun talking to people on the server. You will be able to check for new information about the project and its sneak-peeks. Join us for the best experience!
